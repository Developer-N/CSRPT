...
class WidgetNotificationFragment : PreferenceFragmentCompat(),
    ...
    private var widgetNextAthanTextColorPreferences: Preference? = null
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        preferenceScreen = preferenceManager.createPreferenceScreen(activity).build {
            ...
            section(R.string.pref_widget) {
                ...
                clickable(onClick = {
                    showColorPickerDialog(activity, 1, PREF_SELECTED_WIDGET_TEXT_COLOR)
                }) {
                ...
                clickable(onClick = {
                    showColorPickerDialog(activity, 2, PREF_SELECTED_WIDGET_NEXT_ATHAN_TEXT_COLOR)
                }) {
                    title(R.string.widget_next_athan_text_color)
                    summary(R.string.select_widgets_next_athan_text_color)
                    widgetNextAthanTextColorPreferences = this
                }
                clickable(onClick = {
                    showColorPickerDialog(activity, 3, PREF_SELECTED_WIDGET_BACKGROUND_COLOR)
                }) {
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences?, key: String?) {
        ...
        if (Theme.isDynamicColor(sharedPreferences)) {
            ...
            widgetNextAthanTextColorPreferences?.isVisible = !prefersSystemColors
