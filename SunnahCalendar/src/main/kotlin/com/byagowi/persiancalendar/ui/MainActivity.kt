...
import ir.namoo.commons.NAVIGATE_TO_UD
...
//            header.seasonImage.setImageResource(season.imageId)
        ...
        if (isNetworkConnected(this) && appPrefs.getInt(PREF_LAST_UPDATE_CHECK, 1) !=
    ...
    private fun checkForUpdate() {
        lifecycleScope.launchWhenCreated {
            runCatching {
                val serverLastUpdate = prayTimesService.getLastUpdateInfo().last()
