...
public enum class EventType(
  ...
  Iran("https://calendar.ut.ac.ir/Fa/News/Data/Doc/Calendar%201402.pdf"),
...
public val persianEvents: List<CalendarRecord> = listOf(
  ...
  CalendarRecord(
    ...
    type = EventType.Iran, isHoliday = false, month = 7, day = 9
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "جشن آبانگاه",
    type = EventType.AncientIran, isHoliday = false, month = 1, day = 10
  ),
  CalendarRecord(
    title = "جشن سیزده‌بدر",
  ...
  CalendarRecord(
    ...
    type = EventType.AncientIran, isHoliday = false, month = 1, day = 17
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.AncientIran, isHoliday = false, month = 2, day = 3
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.AncientIran, isHoliday = false, month = 2, day = 15
  ),
  CalendarRecord(
    title = "ارغاسوان، جشن گرما",
    type = EventType.AncientIran, isHoliday = false, month = 3, day = 1
  ),
  CalendarRecord(
    title = "خردادروز، جشن خردادگان",
    type = EventType.AncientIran, isHoliday = false, month = 3, day = 6
  ),
  CalendarRecord(
    title =
        "جشن آب‌پاشونک، جشن آغاز تابستان / سال نو در گاهشماری گاهنباری / دیدار طلوع خورشید در تقویم آفتابی چارتاقی نیاسر",
    type = EventType.AncientIran, isHoliday = false, month = 4, day = 1
  ),
  CalendarRecord(
    title = "جشن نیلوفر",
    type = EventType.AncientIran, isHoliday = false, month = 4, day = 6
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    title = "جشن خام‌خواری",
    type = EventType.AncientIran, isHoliday = false, month = 4, day = 15
  ),
  CalendarRecord(
    title = "مردادروز، جشن مردادگان",
    type = EventType.AncientIran, isHoliday = false, month = 5, day = 7
  ),
  CalendarRecord(
    title = "جشن چلهٔ تابستان",
    type = EventType.AncientIran, isHoliday = false, month = 5, day = 10
  ),
  CalendarRecord(
    title = "گاهنبار میدیوشِم، جشن میانهٔ تابستان",
    type = EventType.AncientIran, isHoliday = false, month = 5, day = 15
  ),
  CalendarRecord(
    title = "جشن مَی‌خواره",
    type = EventType.AncientIran, isHoliday = false, month = 5, day = 18
  ),
  CalendarRecord(
    title = "فغدیه، جشن خنکی هوا",
    type = EventType.AncientIran, isHoliday = false, month = 6, day = 1
  ),
  CalendarRecord(
    title = "جشن کشمین",
  ...
  CalendarRecord(
    ...
    type = EventType.AncientIran, isHoliday = false, month = 6, day = 4
  ),
  CalendarRecord(
    title = "خزان‌جشن",
    type = EventType.AncientIran, isHoliday = false, month = 6, day = 8
  ),
  CalendarRecord(
    title = "بازارجشن",
    type = EventType.AncientIran, isHoliday = false, month = 6, day = 15
  ),
  CalendarRecord(
    title = "گاهنبار پَتیَه‌شَهیم، جشن پایان تابستان",
    type = EventType.AncientIran, isHoliday = false, month = 6, day = 31
  ),
  CalendarRecord(
    title = "جشن میتراکانا / سال نو هخامنشی",
    type = EventType.AncientIran, isHoliday = false, month = 7, day = 1
  ),
  CalendarRecord(
    title = "آیین قالیشویان اردهال، بازماندی از تیرگان",
    type = EventType.AncientIran, isHoliday = false, month = 7, day = 12
  ),
  CalendarRecord(
    title = "تیرروز، جشن تیرروزی",
    type = EventType.AncientIran, isHoliday = false, month = 7, day = 13
  ),
  CalendarRecord(
    title = "مهرروز، جشن مهرگان",
    type = EventType.AncientIran, isHoliday = false, month = 7, day = 16
  ),
  CalendarRecord(
    title = "رام‌روز، جشن رام‌روزی / جشن پیروزی کاوه و فریدون",
    type = EventType.AncientIran, isHoliday = false, month = 7, day = 21
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.AncientIran, isHoliday = false, month = 8, day = 10
  ),
  CalendarRecord(
    title = "گاهنبار اَیاثرَم، جشن میانهٔ پاییز",
    type = EventType.AncientIran, isHoliday = false, month = 8, day = 15
  ),
  CalendarRecord(
    title = "آذرجشن",
    type = EventType.AncientIran, isHoliday = false, month = 9, day = 1
  ),
  CalendarRecord(
    title = "آذرروز، جشن آذرگان",
    type = EventType.AncientIran, isHoliday = false, month = 9, day = 9
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 1
  ),
  CalendarRecord(
    title = "بازارجشن",
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 5
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 14
  ),
  CalendarRecord(
    title = "جشن پیکرتراشی / دی‌به‌مهرروز، سومین جشن دیگان",
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 15
  ),
  CalendarRecord(
    title = "جشن درامزینان، جشن درفش‌ها",
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 16
  ),
  CalendarRecord(
    title = "دی‌به‌دین‌روز، چهارمین جشن دیگان",
    type = EventType.AncientIran, isHoliday = false, month = 10, day = 23
  ),
  CalendarRecord(
    title = "زادروز فردوسی",
    type = EventType.AncientIran, isHoliday = false, month = 11, day = 1
  ),
  CalendarRecord(
    title = "بهمن‌روز، جشن بهمنگان",
    type = EventType.AncientIran, isHoliday = false, month = 11, day = 2
  ),
  CalendarRecord(
    title = "شهریورروز، آغاز پادشاهی داراب (کوروش)",
    type = EventType.AncientIran, isHoliday = false, month = 11, day = 4
  ),
  CalendarRecord(
    title = "جشن نوسَره",
    type = EventType.AncientIran, isHoliday = false, month = 11, day = 5
  ),
  CalendarRecord(
  ...
  CalendarRecord(
    ...
    type = EventType.AncientIran, isHoliday = false, month = 11, day = 15
  ),
  CalendarRecord(
    title = "بادروز، جشن بادروزی",
    type = EventType.AncientIran, isHoliday = false, month = 11, day = 22
  ),
  CalendarRecord(
    title = "جشن اسفندی / جشن آبسالان، بهارجشن / نمایش‌بازی همگانی",
    type = EventType.AncientIran, isHoliday = false, month = 12, day = 1
  ),
  CalendarRecord(
    title = "اسفندروز، جشن اسفندگان، گرامیداشت زمین و بانوان / جشن برزگران",
    type = EventType.AncientIran, isHoliday = false, month = 12, day = 5
  ),
  CalendarRecord(
    title = "جشن وخشنکام",
    type = EventType.AncientIran, isHoliday = false, month = 12, day = 10
  ),
  CalendarRecord(
    title = "جشن نوروز رودها",
    type = EventType.AncientIran, isHoliday = false, month = 12, day = 19
  ),
  CalendarRecord(
    title = "جشن گلدان",
    type = EventType.AncientIran, isHoliday = false, month = 12, day = 20
  ),
  CalendarRecord(
    title = "هزارهٔ شاهنامه، هزارمین سالگرد پایان سرایش شاهنامهٔ فردوسی",
    type = EventType.AncientIran, isHoliday = false, month = 12, day = 25
  ),
  CalendarRecord(
    title = "فروردگان",
    type = EventType.AncientIran, isHoliday = false, month = 12, day = 26
  ),
  CalendarRecord(
    title =
    ...
    type = EventType.AncientIran, isHoliday = false, month = 12, day = 29
  ),
  CalendarRecord(
...
public val gregorianEvents: List<CalendarRecord> = listOf(
  ...
  CalendarRecord(
    title = "روز جهانی روان‌شناس و مشاور",
  ...
  CalendarRecord(
    title = "روز جهانی والدین",
    type = EventType.International, isHoliday = false, month = 6, day = 1
  ),
  CalendarRecord(
...
public val irregularRecurringEvents: List<Map<String, String>> = listOf(
  ...
  mapOf(
    ...
    "type" to "Afghanistan",
    "title" to
        "هفته مبارزه علیه مواد مخدر که از تاریخ ۲۶ جون (روز جهانی مبارزه علیه مواد مخدر) آغاز می‌گردد",
    "holiday" to "false",
  ),
  mapOf(
    "calendar" to "Gregorian",
