    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        listOf(
            R.string.pref_interface to listOf(
                ...
                ListPreference(context).also {
                    it.key = PREF_APP_FONT
                    it.setTitle(R.string.fonts)
                    it.setDialogTitle(R.string.fonts)
                    it.setDefaultValue(SYSTEM_DEFAULT_FONT)
                    it.setEntries(R.array.fontNames)
                    it.setEntryValues(R.array.fontKeys)
                    it.setNegativeButtonText(R.string.cancel)
                    it.summaryProvider = ListPreference.SimpleSummaryProvider.getInstance()
                },
